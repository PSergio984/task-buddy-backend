...
async def list_projects(
    ...
    projects = await project_crud.get_projects(db, user_id=current_user.id, limit=limit, offset=offset)
...
async def delete_project(
    ...
    await project_crud.delete_project(db, db_project=db_project, user_id=current_user.id, delete_tasks=delete_tasks)
    await db.commit()
